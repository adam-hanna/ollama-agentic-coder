...
class StatusBar:
    ...
    def create_status_display(self) -> Panel:
        ...
        table.add_row("📁 Indexing", indexing_text, indexing_time)
        ...
        return Panel(table, title="🔄 System Status", border_style="blue", height=5)
...
class ProgressTracker:
    ...
    def start_operation(
        self, operation_id: str, description: str, total_items: Optional[int] = None
    ):
    ...
    def update_progress(
        self, operation_id: str, completed_items: int, status_message: str = ""
    ):
        ...
        if operation_id in self.operations:
            ...
            shared_context.set(
                f"operation_{operation_id}", self.operations[operation_id]
            )
